 ...
 */
class MailerPassword extends AbstractController
{
    ...
    public function processSendingPasswordResetEmail(string $emailFormData, \Swift_Mailer $mailer): RedirectResponse
    {
        /**
         * @var User
         */
     ...
     public function SendEmailPassword (User $user) 
    {   
        /**
         * @var string
         */
