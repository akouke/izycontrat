        ...
        if ($emailUsed !== true && $formCompany->isSubmitted() && $formPerson->isSubmitted() && $formUser->isSubmitted())
        {
           ...
           if ($nameActivitySector == 'Autres')
            ...
            if( $isConnected === false)
            {
              ...
              $this->addFlash('success', 'Vos informations ont été bien enregistrées. Un mail contenant vos informations de connexion vient de vous être envoyé');
            }
            else{
      ...
      try
       {
        ...
        if ($emailUsed !== true && $formCompany->isSubmitted() && $formPerson->isSubmitted() && $formUser->isSubmitted())
        {
           ...
           if ($nameActivitySector == 'Autres')
            ...
            // $this->addFlash('success', 'Vos informations ont ete bien enregistrées. Un mail contenant vos informations de connexion vient de vous être envoyé');
            return $this->redirectToRoute('create_sarl_prestation', [
                ]);
